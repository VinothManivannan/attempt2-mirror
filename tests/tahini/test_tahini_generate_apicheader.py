...
"""
    ...
    _VERSION = ExtendedVersionInfo(device_type="Don't Care", device_display_name="CM8x4",
                                   config_name="Don't Care", config_id="11", git_versions=[_GITVERSIONS])
...
"""
    ...
    def test_register_with_hif_access(self):
        ...
        expected_body = """\
#define ALPHA                                                 0x404fc /* uint16 */
#define BETA                                               0x40006b14 /* uint16 */
"""
        self.run_test(cmapsource, expected_body)
...
"""
    ...
    def test_repeated_register(self):
        ...
        expected_body = """\
#define BETA0                                                   0x200 /* uint16 */
#define BETA1                                                   0x201 /* uint16 */
#define BETA2                                                   0x202 /* uint16 */
#define BETA3                                                   0x203 /* uint16 */
"""
    ...
    def test_repeated_register_aliased(self):
        ...
        expected_body = """\
#define BETAX                                                   0x200 /* uint16 */
#define BETAY                                                   0x201 /* uint16 */
#define BETAZ                                                   0x202 /* uint16 */
"""
    ...
    def test_state_in_register(self):
        ...
        expected_body = """\
#define ALPHA_REGISTER                                          0x100 /* uint16 */
